...
module.exports = message => {
  ...
  if (message.content.match(/세이아/)) {
    ...
    if (message.content.match(/때문/)) {
      ...
      } else if (message.content.match(/여행/)) {
        var responses = [
      ...
      } else if (message.content.match(/그냥/)) {
        var responses = [
    ...
    } else if (message.content.match(/어때/)) {
      var responses = [
